...
_
  ...
  def create
    ...
    respond_to do |format|
      if @name.save
        format.html { redirect_to name_url(@name), notice: 'Taste was successfully created.' }
  ...
  def destroy
    @name.destroy
      respond_to do |format|
        format.html { redirect_to name_taste_url(@name.roles) }
  ...
  def update
      ...
      if @name.update(role_params)
        format.html { redirect_to name_taste_url(@name.roles)), notice: 'Taste was successfully updated.' }
        format.json { head :no_content }
      else
